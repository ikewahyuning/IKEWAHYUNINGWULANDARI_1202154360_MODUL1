package ike_1202154360_modul1.android.example.com.studycase;
...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast mahal =	Toast.makeText(context,	"Tidak disarankan makan disini, uang anda tidak cukup",	Toast.LENGTH_LONG);
        Toast murah	=	Toast.makeText(context,	"makanan disini murah, silahkan mencoba",	Toast.LENGTH_LONG);
